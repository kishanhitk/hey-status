...
function getServiceStatus(
  ...
  if (incidentStatus === INCIDENT_STATUS.RESOLVED) {
    return SERVICE_STATUS_LABELS[SERVICE_STATUS.OPERATIONAL];
  }

  switch (incidentImpact) {
    case INCIDENT_IMPACT.CRITICAL:
      return SERVICE_STATUS_LABELS[SERVICE_STATUS.MAJOR_OUTAGE];
    case INCIDENT_IMPACT.MAJOR:
      return SERVICE_STATUS_LABELS[SERVICE_STATUS.PARTIAL_OUTAGE];
    case INCIDENT_IMPACT.MINOR:
      return SERVICE_STATUS_LABELS[SERVICE_STATUS.DEGRADED_PERFORMANCE];
    default:
      return SERVICE_STATUS_LABELS[SERVICE_STATUS.OPERATIONAL];
  }
}
