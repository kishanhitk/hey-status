...
export const INCIDENT_STATUS_COLORS = {
  [INCIDENT_STATUS.INVESTIGATING]: "text-yellow-600",
  [INCIDENT_STATUS.IDENTIFIED]: "text-red-600",
  [INCIDENT_STATUS.MONITORING]: "text-blue-600",
  [INCIDENT_STATUS.RESOLVED]: "text-green-600",
};
...
export const MAINTENANCE_STATUS_COLORS = {
  [MAINTENANCE_STATUS.SCHEDULED]: "text-blue-600",
  [MAINTENANCE_STATUS.IN_PROGRESS]: "text-orange-600",
  [MAINTENANCE_STATUS.COMPLETED]: "text-green-600",
};
