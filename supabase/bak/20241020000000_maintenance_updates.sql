...
GRANT ALL ON TABLE "public"."scheduled_maintenances" TO "anon";
GRANT ALL ON TABLE "public"."scheduled_maintenances" TO "authenticated";
GRANT ALL ON TABLE "public"."scheduled_maintenances" TO "service_role";



GRANT ALL ON TABLE "public"."service_status_logs" TO "anon";
GRANT ALL ON TABLE "public"."service_status_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."service_status_logs" TO "service_role";
...
GRANT ALL ON TABLE "public"."services_incidents" TO "anon";
GRANT ALL ON TABLE "public"."services_incidents" TO "authenticated";
GRANT ALL ON TABLE "public"."services_incidents" TO "service_role";



GRANT ALL ON TABLE "public"."services_scheduled_maintenances" TO "anon";
GRANT ALL ON TABLE "public"."services_scheduled_maintenances" TO "authenticated";
GRANT ALL ON TABLE "public"."services_scheduled_maintenances" TO "service_role";



GRANT ALL ON TABLE "public"."uptime_daily_logs" TO "anon";
GRANT ALL ON TABLE "public"."uptime_daily_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."uptime_daily_logs" TO "service_role";
